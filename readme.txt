...
- Forked due to lack of updates upstream
- Fixed regular expression edge cases for footnote detection
- Regular expression updated to play nicer with rust's very common `()` instances
